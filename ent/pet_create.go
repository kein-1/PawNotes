...
func (pc *PetCreate) SetDob(t time.Time) *PetCreate {
	pc.mutation.SetDob(t)
	return pc
}
...
func (pc *PetCreate) check() error {
	...
	if _, ok := pc.mutation.Dob(); !ok {
		return &ValidationError{Name: "dob", err: errors.New(`ent: missing required field "Pet.dob"`)}
	}
	return nil
}
...
func (pc *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.Dob(); ok {
