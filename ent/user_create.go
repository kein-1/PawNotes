...
func (uc *UserCreate) SetFirst(s string) *UserCreate {
	uc.mutation.SetFirst(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.First(); !ok {
		return &ValidationError{Name: "first", err: errors.New(`ent: missing required field "User.first"`)}
	}
