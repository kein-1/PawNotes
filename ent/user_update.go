...
func (uu *UserUpdate) SetFirst(s string) *UserUpdate {
	uu.mutation.SetFirst(s)
	return uu
}

// SetNillableFirst sets the "first" field if the given value is not nil.
func (uu *UserUpdate) SetNillableFirst(s *string) *UserUpdate {
	if s != nil {
		uu.SetFirst(*s)
	}
	return uu
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.First(); ok {
		_spec.SetField(user.FieldFirst, field.TypeString, value)
	}
...
// SetFirst sets the "first" field.
func (uuo *UserUpdateOne) SetFirst(s string) *UserUpdateOne {
	uuo.mutation.SetFirst(s)
	return uuo
}

// SetNillableFirst sets the "first" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableFirst(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetFirst(*s)
	}
	return uuo
